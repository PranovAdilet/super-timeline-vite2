import { Tabs, TabsContent, TabsList, TabsTrigger, useStore } from "@/shared";
import React from "react";

const Animations = () => {
  const { activeIds } = useStore();

  const applyAnimation = (presetName: any, type: "in" | "out") => {
    if (!activeIds.length) {
      ...
      <div className="px-4">
        ...
        >
          ...
          <TabsContent value="in">
            <div className="grid grid-cols-3 gap-2 py-4">{}</div>
          </TabsContent>
