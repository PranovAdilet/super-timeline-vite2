...
export const calculateMediaStyles = (
  ...
  return {
    ...
    boxShadow: [
      ...
      .filter(Boolean)
      .join(", "),
    ...calculateCropStyles(details as any, crop),
...
export const calculateTextStyles = (
  ...
  wordWrap: details.wordWrap || ("" as any),
  wordBreak: details.wordBreak || ("normal" as any),
  textTransform: details.textTransform || "none",
  fontSize: details.fontSize || "16px",
  textAlign: details.textAlign || ("left" as any),
